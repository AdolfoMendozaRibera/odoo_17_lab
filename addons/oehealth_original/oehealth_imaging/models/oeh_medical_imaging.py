...
class OeHealthImagingTypeManagement(models.Model):
    ...
    imaging_department = fields.Many2one('oeh.medical.imagingtest.department', string='Department')
    test_type = fields.Many2one('oeh.medical.imaging.test.type', string='Test Type', domain="[('imaging_department', '=', imaging_department)]", help="Imaging Test type")
    ...
    image6 = fields.Binary(string="Image 6")
