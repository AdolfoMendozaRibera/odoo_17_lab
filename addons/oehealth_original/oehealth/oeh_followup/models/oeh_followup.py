...
class OehMedicalFollowUp(models.Model):
    ...
    patient = fields.Many2one('oeh.medical.patient', readonly=False)
    ...
    followup_date = fields.Datetime('Followup Date', default=datetime.now() + timedelta(days=5), readonly=False)
    fin_followup_datetime = fields.Datetime('Completed Followup Date & Time', readonly=False)
